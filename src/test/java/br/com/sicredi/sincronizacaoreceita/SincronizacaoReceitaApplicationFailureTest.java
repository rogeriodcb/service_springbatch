...
/**
* <b>SincronizacaoReceitaApplicationFailureTest</b>
* <br>This test is focused to give an input file with wrong data to process by ReceitaService.
* <br>This line can be written into output file and the last column shall be FALSE in these wrong data rows.
* <br>To execute the test the file InputDataWrong.csv
...
@SpringBatchTest
@SpringBootTest(args ="C:\\temp\\InputDataWrong.csv")
@RunWith(SpringRunner.class)
public class SincronizacaoReceitaApplicationFailureTest {
	@Autowired
	...
	*/
    ...
    public static void Init() {
    	...
    	System.out.println("=                   Existing file and wrong data                 =");
    	System.out.println("==================================================================");
    }
    ...
    public void TestJob2() throws Exception {
    	...
    	/***************** initial setup *****************/
        System.out.println("Starting TestJob - data wrong but valid...");
        String in = "C:\\temp\\InputDataWrong.csv";
        String[] linesToCheck = {
        		"agencia;conta;saldo;status;resultado",
        		"0101;12225-6;100,00;F;FAIL",
        		"0101;12226-8;3200,50;A;Ok",
        		"3202;40011-1;-35,12;I;Ok",
        		"3202;54001-2;0,00;P;Ok",
        		"3202;00321-2;34500,00;K;FAIL"
